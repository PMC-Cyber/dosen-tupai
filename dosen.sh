...
printf "\n"
printf "\e[1;93m[\e[0m\e[1;77m99\e[0m\e[1;93m]\e[0m\e[1;77m Exit   \e[1;93m[\e[0m\e[1;77mUP\e[0m\e[1;93m]\e[0m\e[1;77m Update   \e[1;93m[\e[0m\e[1;77mBK\e[0m\e[1;93m]\e[0m\e[1;77m Back Menu\e[0m\n"
...
lockmenu() {
echo " "
read -p $'\e[1;31m[\033[37m•\033[31m] >>\e[0m\e[1;96m  \en' choice
...
printf "\e[0m\n"
printf "  \e[0m\e[1;91m[\e[0m\e[1;97m01\e[0m\e[1;91m]\e[0m\e[1;93m MASUK MENU INSTALL\e[0m\n"
printf "  \e[0m\e[1;91m[\e[0m\e[1;97m02\e[0m\e[1;91m]\e[0m\e[1;93m MENGUPTADE TOOLS OS\e[0m\n"
printf "  \e[0m\e[1;91m[\e[0m\e[1;97m03\e[0m\e[1;91m]\e[0m\e[1;93m EXIT LOGOUT\e[0m\n"
printf "\e[0m\n"
...
sleep 1s
echo  " "
echo "${BL}[${R}!${BL}] ${G}Tuan Sedang masuk Script Update  "
sleep 1s
echo "${BL}[${R}✓${BL}] ${G}Loading Installing Update..."
    echo " "
      sleep 2s
